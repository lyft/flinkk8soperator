...
type CreateIfNotExistFunc func(ctx context.Context, application *v1beta2.FlinkApplication) (bool, error)
...
func (m *TaskManagerController) CreateIfNotExist(
	ctx context.Context, application *v1beta2.FlinkApplication) (bool, error) {
