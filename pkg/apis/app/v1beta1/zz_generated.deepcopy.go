...
func (in *FlinkApplicationStatus) DeepCopyInto(out *FlinkApplicationStatus) {
	*out = *in
	...
	if in.AppStatus != nil {
		...
		*out = make([]FlinkSubApplicationStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FlinkSubApplicationStatus) DeepCopyInto(out *FlinkSubApplicationStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FlinkSubApplicationStatus.
func (in *FlinkSubApplicationStatus) DeepCopy() *FlinkSubApplicationStatus {
	if in == nil {
		return nil
	}
	out := new(FlinkSubApplicationStatus)
	in.DeepCopyInto(out)
	return out
}
