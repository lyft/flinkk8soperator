...
func (c *FakeFlinkApplications) Create(ctx context.Context, flinkApplication *v1beta1.FlinkApplication) (result *v1beta1.FlinkApplication, err error) {
	obj, err := c.Fake.
...
func (c *FakeFlinkApplications) Update(ctx context.Context, flinkApplication *v1beta1.FlinkApplication) (result *v1beta1.FlinkApplication, err error) {
	obj, err := c.Fake.
...
func (c *FakeFlinkApplications) Delete(ctx context.Context, name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeFlinkApplications) DeleteCollection(ctx context.Context, options *v1.DeleteOptions, listOptions v1.ListOptions) error {
...
func (c *FakeFlinkApplications) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.FlinkApplication, err error) {
	obj, err := c.Fake.
