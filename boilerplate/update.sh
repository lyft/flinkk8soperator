...
git clone git@github.com:lyft/boilerplate.git /tmp/boilerplate

echo "Updating the update.sh script."
cp "/tmp/boilerplate/boilerplate/update.sh" "${DIR}/update.sh"
echo ""
...
while read directory; do
  ...
  dir_path="/tmp/boilerplate/boilerplate/${directory}"
  rm -rf "${DIR}/${directory}"
